...
should("minaPoseidon.hash(0)", () => {
  ...
  strictEqual(
    hash,
    21565680844461314807147611702860246336805372493508489110556896454939225549736n
  );
})
...
should("minaPoseidon.hash(|x|=rate)", () => {
  ...
  strictEqual(
    hash,
    6449939084237974168090090163969627591733334698545722094862854383080361015108n
  );
})
